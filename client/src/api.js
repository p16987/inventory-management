...
export const api = {
  ...
  // Reports take the same filter set as orders, so the global filter bar
  // narrows the quarterly and monthly report data too.
  ...
  async createRestockOrder(budget, items) {
    // The server prices the order from the catalogue, so only SKU and quantity are sent.
